...
/**
 * Generated from protobuf message <code>queuer.commands.v1.CreateResponse</code>
 */
class CreateResponse extends \Google\Protobuf\Internal\Message
{
    ...
    /**
     * Generated from protobuf field <code>.queuer.entities.v1.Command command = 2 [json_name = "command"];</code>
     */
