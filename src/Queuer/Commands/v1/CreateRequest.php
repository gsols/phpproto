...
class CreateRequest extends \Google\Protobuf\Internal\Message
{
    ...
    protected $action = 0;
    /**
     * Generated from protobuf field <code>optional string stream_id = 3 [json_name = "streamId", (.validate.rules) = {</code>
     */
    protected $stream_id = null;
    /**
     * Generated from protobuf field <code>optional bytes payload = 4 [json_name = "payload"];</code>
     */
